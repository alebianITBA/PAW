        ...
        function($http, SessionService, CommonService) {
            return {
                ...
                delete: function(applicationId) {
                    return $http.delete(connectOn.constants.API_V1_BASE_URL + '/job_applications/' + applicationId, CommonService.headers());
                },
                create: function(jobOfferId) {
                    return $http.post(connectOn.constants.API_V1_BASE_URL + '/job_applications', {jobOfferId: jobOfferId}, CommonService.headers());
                }
            };
