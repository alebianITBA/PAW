define(['connectOn'], function(connectOn) {
    ...
    'use strict';
    connectOn.controller('PostCtrl', ['$scope', 'PostService', '$routeParams', 'localStorageService', '$location', function($scope, PostService, $routeParams, localStorageService, $location) {
        this.post = {};
