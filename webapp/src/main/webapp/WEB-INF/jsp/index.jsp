					...
					<div class="l_g_r">
						<div class="dapibus">
							...
							<p class="adm">
								...
								<a href="<c:url value='/users/${offer.user.id}'/>">${offer.user.firstName}
									${offer.user.lastName}</a>
							</p>
							<p>${offer.description}</p>
							<p class="skill-container">
								<c:forEach items="${offer.skills}" var="skill">
									<a class="no-underline"
										href="<c:url value='/job_offers?skill_id=${skill.id}'/>">
			...
			<div class="l_g_r biography-into">
				<div class="dapibus">
					...
					<form:form method="post" modelAttribute="postForm"
						action="${postUrl}" class="form-header" role="form" id="#">
						...
						<div class="form-group">
							...
							<form:textarea class="form-control input-lg post-textarea"
								placeholder="${content}*" path="description" />
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<p style="text-align: center;">
								<b> <spring:message code="NoPost" /><br /> <spring:message
										code="BeTheFirstOneToPost" /></b>
							</p>
						</c:otherwise>
					</c:choose>
				</div>
...
<script type="text/javascript"
	src="<c:url value='/script/pagination.js'/>"></script>
