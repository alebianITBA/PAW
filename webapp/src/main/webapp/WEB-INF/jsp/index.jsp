         ...
         <div class="col-md-4 praesent f-right">
            <div class="l_g_r">
               <div class="dapibus">
                  ...
                  <p class="adm"><spring:message code="PostedBy"/> <a href="/users/${offers[0].userId}">${offers[0].user.firstName} ${offers[0].user.lastName}</a></p>
               ...
               <c:choose>
                  <c:when test="${fn:length(posts) gt 0}">
                     <c:forEach items="${posts}" var="post">
                        <hr>
                        <h4>${post.title}</h4>
                        <p class="adm"><spring:message code="PostedBy"/> <a href="/users/${post.userId}">${post.user.firstName} ${post.user.lastName}</a></p>
